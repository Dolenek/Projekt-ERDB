...
public sealed class LocalPuzzlePolicyTests
{
    [Fact]
    public void UnvalidatedDefaults_NeverAllowAutomaticAnswers()
    {
        Assert.False(new LocalPuzzlePolicy().AllowsAutomaticAnswers("templates", new[] { "apple" }));
    }
    ...
    private static LocalPuzzlePolicy ValidPolicy()
    {
