...
{
    public sealed class PuzzleDebugArtifactWriter
    {
        private readonly bool _enabled;
        private readonly string _outputDirectory;

        public PuzzleDebugArtifactWriter()
        {
            _enabled = !string.Equals(Env.Get("PUZZLE_DEBUG_CAPTURE", "0"), "0", StringComparison.OrdinalIgnoreCase);
        ...
        {
            var mediaType = EpicRPGBot.UI.Puzzle.PuzzleImageMediaTypeDetector.Detect(bytes);
        ...
        {
            var raw = Env.Get("PUZZLE_DEBUG_DIR", "artifacts/puzzle-debug");
