...
{
    internal sealed class PuzzleTemplateVariant : IDisposable
    {
        private readonly List<ColorReference> _colorReferences = new List<ColorReference>();
        public PuzzleTemplateVariant(string label, Mat colors, int angle = 0, int length = 0, double aspect = 1,
            string sourceKey = null)
        {
            ...
            MaximumGray = PuzzleLuminance.MaximumChannel(colors);
