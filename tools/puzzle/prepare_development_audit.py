...
BATCH = ROOT / 'artifacts/puzzle-training-20260908'
ADDITIONS = ROOT / 'artifacts/puzzle-additions-20260909'
...
def correct_confirmed_label():
    ...
    summary['annotationAudit'] = '../puzzle-additions-20260909/annotation-audit.json'
