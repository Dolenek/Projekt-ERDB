...
- `Bot Parameters` section: area, `Ascended`, a `Work commands` button, and hunt/adventure/work/farm/lootbox cooldown baselines
...
- Existing keys are preserved and extended with `ascended` and `work_commands`.
