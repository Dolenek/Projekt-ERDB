...
- Work-commands dialog: `WorkCommandsWindow`, `WorkCommandsCloseButton`, `WorkCommandsMinimizeButton`, `WorkCommandsMaximizeRestoreButton`, `WorkCommandsWindowCloseButton`, and `WorkCommandArea{N}Input` for areas `1..15`
