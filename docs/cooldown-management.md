...
- Keys currently used:
  ...
  - `work_ms`
  - `farm_ms`
- On app load, `hunt_ms`, `work_ms`, and `farm_ms` are restored directly into the settings textboxes.
...
4. Update the Hunt, Work, and Farm textboxes with the saved milliseconds.
