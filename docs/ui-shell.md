...
- Right pane: channel URL, area/cooldown inputs for hunt/adventure/work/farm/lootbox, `Start Bot`, `Stop Bot`, `Inicialize`, `rpg cd`, and visual cooldown labels.
...
- `Inicialize` runs the cooldown discovery workflow on the bot tab only.
