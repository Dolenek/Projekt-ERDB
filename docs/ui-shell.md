...
- Right pane: channel URL, area/cooldown inputs for hunt/adventure/work/farm, `Start Bot`, `Stop Bot`, `Inicialize`, and visual cooldown labels.
...
- `Start Bot` immediately sends `rpg cd`, starts the automation engine, and waits for the cooldown snapshot before scheduling commands.
